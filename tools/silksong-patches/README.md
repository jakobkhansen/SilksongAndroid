...
For the dual-screen layout, HUD routing and input regressions:
...
| `dualscreen/` | the second screen — see `docs/DUALSCREEN-V2.md` and the first visual slice in `docs/DUALSCREEN-V3.md` |
